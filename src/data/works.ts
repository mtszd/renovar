...
export const works: Work[] = [
  ...
  },
  {
    ...
    description:
      "El supermercado Arcoiris apostó por la eficiencia energética mediante la instalación de un sistema solar On Grid de 64,35 kWp en su sucursal de Las Parejas. Esta solución cubre la totalidad del consumo eléctrico de uno de sus suministros, generando un ahorro significativo y fortaleciendo su imagen como empresa comprometida con el cuidado ambiental.",
  ...
  },
  {
    ...
    title: "CADE",
    description:
      "La empresa metalúrgica CADE incorporó un sistema solar On Grid de 32,2 kWp en su planta de Carcarañá. Este sistema cubre su consumo energético completo, reduciendo costos operativos y mejorando su competitividad en el sector industrial, al tiempo que promueve prácticas sustentables.",
  ...
  },
  {
    ...
    title: "Hardfacing",
    description:
      "Hardfacing, ubicada en el Parque Industrial de San Lorenzo, implementó un sistema On Grid de 34,2 kWp con una estructura triangular para optimizar la captación solar en techos orientados al sur. Con esta mejora, la empresa asegura eficiencia energética y un fuerte compromiso ambiental.",
  ...
  },
  {
    ...
    description:
      "La cadena de restaurantes Mostaza decidió incorporar energía solar en su local de Rosario con un sistema On Grid de 34,5 kWp. Este sistema cubre el 30 % del consumo energético del establecimiento, generando ahorros directos en su factura eléctrica y reforzando su posicionamiento como empresa moderna y sustentable.",
    location: "Rosario – Santa Fe",
    type: "Comercial",
    imageCount: 7, // Manteniendo el valor original
    technicalDetails: {
  ...
  },
  {
    ...
    description:
      "Esta vivienda de Granadero Baigorria incorporó un sistema solar On Grid de 4,4 kWp que cubre su consumo energético total. El sistema está conectado a la red y permite inyectar excedentes, lo que se traduce en ahorro económico y en un mayor compromiso con el ambiente.",
  ...
  },
  {
    ...
    title: "OAISA",
    description:
      "La empresa química OAISA instaló un sistema solar On Grid de 17,55 kWp en su planta de Rosario. Gracias a una estructura triangular que reorienta los paneles hacia el norte, la instalación maximiza la captación solar, mejorando la eficiencia operativa y reduciendo su huella ambiental.",
    location: "Rosario – Santa Fe",
    type: "Comercial",
    imageCount: 15,
    technicalDetails: {
  ...
  },
  {
    ...
    description:
      "Esta estación de servicio Shell, ubicada en Humberto Primo, incorporó un sistema fotovoltaico On Grid de 19,55 kWp para cubrir su consumo energético anual. La instalación representa un importante ahorro económico y una apuesta firme por la transición energética.",
  ...
  },
  {
    ...
    description:
      "Distribuidora Tieppo de alimentos, en su planta de Casilda, instaló un sistema solar On Grid de 40,6 kWp para abastecer toda su demanda energética. Esta acción reafirma su compromiso con la eficiencia operativa, la sostenibilidad y la reducción de la huella de carbono.",
